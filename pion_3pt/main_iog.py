...
# filepath = np.array([ 
#     '/public/home/sush/3pt_distillation/pion/result/%dx%d/Px%dPy%dPz%d/test/ENV_%d/conf%d/corr_uud_gamma4_3pt_tseq%d_link_indx%d_U_1000_peram_to_prop.dat', 
#     '/public/home/sush/3pt_distillation/pion/result/%dx%d/Px%dPy%dPz%d/test/ENV_%d/conf%d/corr_uud_gamma4_3pt_tseq%d_link_indx%d_U_1000_peram_to_prop_none.dat',
...
#     ])
filepath = np.array([
    '/public/home/sush/share_work/chroma/beta7.0_mu-0.1600_ms-0.1450_L%dx%d/mom_grid_source/new/pion_2pt_Px%dPy%dPz%d_ENV%d_conf%d_tsep-1_mass-0.1450.iog'
    ])
analyse = data_analyse(
    ...
    tsep=np.asarray([-1]),
    time_fold=0,
    save_path='/public/home/sush/3pt_distillation/analyse/pion/48x64',
    link_max=0,
    analyse_type='2pt',
    meff_type='cosh',
    read_type='iog',
...
# analyse.plot_link_ratio([0,1.23], num=1)
# analyse.plot_link_C3pt_C3pt([0,1.01])
# print(analyse.link_y['link_data_U']+analyse.link_y['link_data_D'])
# print(analyse.link_err['link_data_U'])
# analyse.plot_PDF_ENV('U',[0,1.23])
# analyse.plot_link_indx_ENV(1, [0.829,0.86], normal=1)
print('complete')
# X = analyse.ENV
