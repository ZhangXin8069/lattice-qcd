...
#diagram 1
		st=time.time()
		twopt_1_N[:,:, t_sink, t_source]=contract("vabc, afkp, bglq, chmr, kl, pq, wfgh -> vwmr", VVV_sink, peram_u[t_sink], peram_u[t_sink], peram_u[t_sink,:,:,0:2,0:2], gsink_baryon, gsource_baryon, cp.conj(VVV_source))
		twopt_2_N[:,:, t_sink, t_source]=contract("vabc, ahkr, bglq, cfmp, kl, pq, wfgh -> vwmr", VVV_sink, peram_u[t_sink,:,:,:,0:2], peram_u[t_sink], peram_u[t_sink,:,:,0:2,:], gsink_baryon, gsource_baryon, cp.conj(VVV_source))
