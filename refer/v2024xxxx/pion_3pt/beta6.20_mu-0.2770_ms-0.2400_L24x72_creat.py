...
chroma = creat_chroma_ini(
    ...
    out_path = '/public/home/sushihao/share_work/chroma/beta6.20_mu-0.2770_ms-0.2400_L24x72/proton/',
)
if hadron == 'pion':
...
chroma.building_block(links_dir = '3', links_max = '10', frwd_prop_id='prop', bkwd_prop_id = 'seq_prop_U', Flavor = 'U', conserved = 'false', use_cpu = 'true', gauge = 'gauge')
chroma.end()