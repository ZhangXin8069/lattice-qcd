...
do
	...
	./2pt.pl  ${i} $prefix > ./ini_out_file/ini_${i}.xml
	HIP_DB=0 QUDA_ENABLE_P2P=0 QUDA_ENABLE_TUNING=0 \
	mpirun -mca btl_tcp_if_include ib0 -n 64  ./chroma  -i ./ini_out_file/ini_${i}.xml    -o ./ini_out_file/out_${i}.xml >./log_file/log_${i}   2>&1
	#break
done
